...
namespace huhocall.Callouts
{
    ...
    [CalloutInfo("Stolen lazer", CalloutProbability.Medium)]

    public class StolenLazer : Callout
    {
        private Ped Suspect;
        ...
        public override bool OnBeforeCalloutDisplayed()
        {
            ...
            CalloutMessage = "A marine spotted a stolen lazer";
            CalloutPosition = Spawnpoint;
            Functions.PlayScannerAudioUsingPosition("ATTENTION_ALL_UNITS_01 CITIZENS_REPORT_01 CRIME_GRAND_THEFT_AUTO_01 SUSPECT_IS_01 IN_A_02 LAZER_01 IN_OR_ON_POSITION", Spawnpoint);

            return base.OnBeforeCalloutDisplayed();
        }
        public override bool OnCalloutAccepted()
        {
            SuspectVehicle = new Vehicle("LAZER", Spawnpoint);
